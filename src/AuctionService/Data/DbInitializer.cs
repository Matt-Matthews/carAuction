...
namespace AuctionService.Data
{
    public class DbInitializer
    {
        public static void InitDb(WebApplication app)
        {
            ...
            var url = app.Configuration.GetConnectionString("DefaultConnection") ?? "Server=localhost:5432;User Id=postgres;Password=postgresspw;Database=auctions;Integrated Security=true;Pooling=true";

            SeedData(_context, url);
        }

        private static void SeedData(AuctionDbContext context, string url)
        {
